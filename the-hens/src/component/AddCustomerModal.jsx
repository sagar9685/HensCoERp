        ...
        <div className={styles.modalBody}>
          <form onSubmit={handleSubmit}>
            <div className={styles.formGrid}>
              ...
              {/* Alternate Phone */}
              <div className={styles.inputGroup}>
                <label className={styles.inputLabel}>Alternate Phone</label>
                <input
                  type="tel"
                  name="alternatePhone"
              ...
              <div className={styles.inputGroup}>
                <label className={styles.inputLabel}>Gst_No</label>
                <input
                  type="text"
                  name="Gst_No"
              ...
              <div className={styles.inputGroup}>
                <label className={styles.inputLabel}>Credit Limit</label>
                <input
                  type="number"
                  name="creditLimit"

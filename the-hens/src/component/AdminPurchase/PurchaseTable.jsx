  ...
  return (
    <div className={styles.tableContainer}>
      <div className={styles.tableWrapper}>
       ...
       {/* // In PurchaseTable.js - update the table headers and rows */}
<thead>
  <tr>
    <th>PO Number</th>
    <th>Items</th>
...
<tbody>
  {currentPurchases.length > 0 ? (
    currentPurchases.map((purchase) => (
      <tr key={purchase.po_number} className={styles.tableRow}>
        ...
        {/* <td className={styles.status}>
          <span className={`${styles.statusBadge} ${styles[purchase.status] || styles.pending}`}>
    ...
    <tr>
      <td colSpan="6" className={styles.noData}> {/* Update colSpan to 6 */}
        <FaBox />
